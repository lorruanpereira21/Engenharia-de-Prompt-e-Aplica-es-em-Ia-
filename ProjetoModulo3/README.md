...
Desafio Escolhido
Automatize o envio de e-mails de confirmação sempre que um usuário preencha um formulário de contato online, sem escrever nenhuma linha de código. O fluxo integra Google Forms, Google Sheets, Google Gemini e Gmail, disparando uma mensagem personalizada e inteligente automaticamente a cada nova resposta.

Plataformas Utilizadas
Fazer
Formulários Google
Planilhas Google (Banco de Dados)
Gêmeos
Gmail
Protótipo
Formulários: https://forms.gle/w6sriwgHkjqUK9Ui9

Make: https://us2.make.com/public/shared-scenario/9Fhp3hOTRc6/integration-google-sheets-gmail

Impressões do funcionamento:

Imprimir 1: Cenário no Make com módulos conectados, com a IA integrada.
Imprimir 2: Formulário para envio dos dados.
Print 3: Planilha com os dados para o e-mail.
Print 4: E-mail recebido na caixa de entrada, com a resposta gerada por IA.
Como o dépô funciona:

O usuário preenche o Google Forms com nome, e-mail e mensagem.
A resposta é registrada automaticamente em uma planilha do Planilhas Google.
...
O Make foi escolhido por ser gratuito, visual, intuitivo e especializado em automatizações de fluxo entre sistemas de forma simples. Para o desafio proposto (integrar um IA + Forms + Excel + Gmail), ele oferece conectores de aplicativos prontos, o que permite criar e testar o protótipo em pouco tempo de produção. Seria a escolha ideal para um projeto de curto prazo.
...
Limitações
Dependência de múltiplas plataformas: o fluxo depende simultaneamente do Make, Google Forms, Sheets, Gemini e Gmail. Uma instabilidade em qualquer um desses serviços interrompido toda a automação.
